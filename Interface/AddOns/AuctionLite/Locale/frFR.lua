...
L["Auction house data cleared."] = "Données de l'h^otel des ventes effacées."
...
L["Auction scan skipped (control key is down)"] = "Analyse des ventes annulée (Touche Contr^ole enfoncée)"
L["Batch %d: %d at %s"] = "Lot %d : %d à %s"
L["Below AH"] = "En dessous de l'HV"
L["Bid cost for %d:"] = "Co^ut d'enchère pour %d :"
...
L["Buyout cost for %d:"] = "Co^ut d'achat pour %d :"
...
L["CANCEL_CONFIRM_TEXT"] = "Certaines de vos enchères ont recus des offres. Souhaitez-vous annuler toutes vos enchères, seulement celles sans offres, ou ne rien faire ?"
...
L["|cffff0000Not enough cash for deposit.|r"] = "|cffff0000Pas assez d'argent pour le dép^ot.|r"
...
L["|cffff0000[Warning]|r Skipping your own auctions.  You might want to cancel them instead."] = "|cffff0000[Attention]|r Vos propres enchères ont été ignorées. Vous devriez plut^ot les annuler."
...
L["Choose which tab is selected when opening the auction house."] = "Choississez l'onglet à afficher lors de l'ouverture de la fenêtre de l'h^otel des ventes."
L["Clear All"] = "Tout effacer"
L["Clear all auction house price data."] = "Efface toutes les données des prix de l'h^otel des ventes."
L["Clear All Data"] = "Effacer les données"
L["CLEAR_DATA_WARNING"] = "^Etes-vous s^ur de vouloir supprimer toutes les données des prix de l'h^otel des ventes récoltées par AuctionLite ?"
...
L["FAST_SCAN_AD"] = [=[L'analyse rapide des enchères d'AuctionLite est capable d'analyser tout l'h^otel des ventes en quelques secondes.
...
L["Name"] = "Nom"
L["Net cost for %d:"] = "Co^ut net pour %d :"
L["Never"] = "Jamais"
L["New..."] = "Nouveau"
...
L["Not enough cash for deposit."] = "Pas assez d'argent pour le dép^ot."
...
L["Open all your bags when you visit the auction house."] = "Ouvre tous vos sacs quand vous visitez l'h^otel des ventes."
...
L["Right Side of AH"] = "C^oté droid de l'HV"
...
L["Show auction house value in tooltips."] = "Affiche la valeur de l'h^otel des ventes dans les bulles d'aide."
...
L["Use Coin Icons in Tooltips"] = "Utiliser les ic^ones des pièces"
...
L["Uses the standard gold/silver/copper icons in tooltips."] = "Utilise les ic^ones standards de l'or/l'argent/le bronze dans les bulles d'aide."
L["Vendor"] = "Marchand"
