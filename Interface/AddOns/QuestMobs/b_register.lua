...
--<<DEFAULTS>>--------------------------------------------------------------------------------------<<>>
    ...
    local Defaults = {
        ...
        TextureVariant = 1,
        Alpha = 1,
        NormalQuestcolor = {r = 1, g = 1, b = 0},
        GroupQuestcolor = {r = 1, g = 0.5, b = 0},
        AreaQuestcolor = {r = 0, g = 1, b = 1},
        Scale = 1,
        IconXOffset = 0,
        IconYOffset = 0,
        TasksXOffset = 0,
...
--<<REGISTER THE ADDON WITH KIB_CONFIG (If available)>>---------------------------------------------<<>>
    ...
    local SavedVars, GlobalDatabase = Defaults, {Font = STANDARD_TEXT_FONT, Localization = GetLocale()}
