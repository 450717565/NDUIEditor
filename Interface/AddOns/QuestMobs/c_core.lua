...
--<<CREATE QUEST ICON>>-----------------------------------------------------------------------------<<>>
    ...
    local function CreateQuestIcon(plateFrame)  
        ...
        plateFrame.Quest_IconTexture:SetTexture("Interface\\AddOns\\QuestMobs\\media\\questicon_" .. SavedVars.TextureVariant)
...
--<<HANDLE QUEST DATA>>-----------------------------------------------------------------------------<<>>
    ...
    local function HandleQuestData(plateData)                                                   --GlobalDatabase.EventBucket_AddLine("QuestMobs", "Plate Updated: " .. plateData.unitName)
...
--<<SCAN QUEST DATA>>-------------------------------------------------------------------------------<<>>
    ...
    local function ScanPlate(plateData)                                                         --GlobalDatabase.EventBucket_AddLine("QuestMobs", "Plate Scanned and Cached: " .. plateData.unitName)
    ...
    local function ScanAllPlates()                                                              --GlobalDatabase.EventBucket_AddLine("QuestMobs", "All Plates Scanned and Cached")
...
--<<HANDLE EVENTS>>---------------------------------------------------------------------------------<<>>
    ...
    function LocalDatabase.NAME_PLATE_UNIT_REMOVED(plateID)                                     --GlobalDatabase.EventBucket_AddLine("QuestMobs", "Plate Removed: " .. UnitName(plateID))
        if Visible_Plates[plateID] then Visible_Plates[plateID] = nil end
    end

    function LocalDatabase.NAME_PLATE_UNIT_ADDED(plateID)                                       --GlobalDatabase.EventBucket_AddLine("QuestMobs", "Plate Found: " .. UnitName(plateID))
