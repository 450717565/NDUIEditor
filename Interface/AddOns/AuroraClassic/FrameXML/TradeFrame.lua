...
tinsert(C.themes["AuroraClassic"], function()
	...
	F.StripTextures(TradePlayerItemsInset, true)
	F.StripTextures(TradeRecipientItemsInset, true)
	F.StripTextures(TradePlayerEnchantInset, true)
	F.StripTextures(TradeRecipientEnchantInset, true)
	F.StripTextures(TradePlayerInputMoneyInset, true)
	F.StripTextures(TradeRecipientMoneyInset, true)
