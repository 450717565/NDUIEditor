...
C.themes["Blizzard_Collections"] = function()
	...
	F.CreateSD(MountJournal.MountCount)
	F.CreateBD(PetJournal.PetCount, .25)
	F.CreateSD(PetJournal.PetCount)
	F.CreateBD(MountJournal.MountDisplay.ModelScene, .25)
	F.CreateSD(MountJournal.MountDisplay.ModelScene)
	...
	F.CreateBDFrame(card.PetInfo.icon)
	...
	F.CreateBD(WardrobeOutfitFrame, .25)
