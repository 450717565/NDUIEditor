...
local function ReskinReputationFrameBars()
...
local function ReskinTokenFrameButtons()
...
tinsert(C.defaultThemes, function()
	...
	do
		...
		hooksecurefunc("ReputationFrame_Update", ReskinReputationFrameBars)
	end
	...
	do
		...
		TokenFrame:HookScript("OnShow", ReskinTokenFrameButtons)
		hooksecurefunc("TokenFrame_Update", ReskinTokenFrameButtons)
		hooksecurefunc(TokenFrameContainer, "update", ReskinTokenFrameButtons)
	end
end)