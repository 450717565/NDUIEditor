...
function module:OnLogin()
	...
	B.CreateGF(MactionbarL1, basicW, 1, "Horizontal", cr, cg, cb, 0, .7)
	...
	B.CreateGF(MactionbarR1, basicW, 1, "Horizontal", cr, cg, cb, .7, 0)
	...
	B.CreateGF(OverbarL1, 250, 1, "Horizontal", cr, cg, cb, 0, .7)
	...
	B.CreateGF(OverbarR1, 250, 1, "Horizontal", cr, cg, cb, .7, 0)
