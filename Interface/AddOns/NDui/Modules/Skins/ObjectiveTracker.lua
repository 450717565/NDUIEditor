...
do
	...
	mover:SetPoint("TOPRIGHT", Minimap, "BOTTOMRIGHT", -60, -30)
	mover:SetSize(60, 60)
...
function module:QuestTracker()
	...
	hooksecurefunc("ScenarioStage_CustomizeBlock", function(block)
		...
		if not block.bg then
			...
			block.bg:SetPoint("TOPLEFT", block.GlowTexture, 2, -2)
			block.bg:SetPoint("BOTTOMRIGHT", block.GlowTexture, -2, 2)
			B.CreateBD(block.bg)
			B.CreateSD(block.bg)
	...
	hooksecurefunc("Scenario_ChallengeMode_ShowBlock", function()
		...
		if not block.bg then
			...
			block.bg:SetPoint("TOPLEFT", 2, -2)
			block.bg:SetPoint("BOTTOMRIGHT", -4, 2)
			B.CreateBD(block.bg)
			B.CreateSD(block.bg)
			B.CreateTex(block.bg)
		end
