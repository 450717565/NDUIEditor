...
local function StartFadeIn(frame)
	...
	frame.fader.anim:SetDuration(frame.faderConfig.fadeInDuration or .25)
...
local function StartFadeOut(frame)
	...
	frame.fader.anim:SetDuration(frame.faderConfig.fadeOutDuration or .25)
...
function AB:CreateButtonFrameFader(buttonList, faderConfig)
