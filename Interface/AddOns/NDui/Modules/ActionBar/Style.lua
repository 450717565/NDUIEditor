...
local function applyBackground(bu)
	...
	if NDuiDB["Actionbar"]["Classcolor"] then
		bu.bg:SetBackdropColor(DB.ClassColor.r, DB.ClassColor.g, DB.ClassColor.b, .2)
	else
...
local function styleActionButton(bu)
	...
	ho:SetPoint("TOPLEFT", bu, 1, -2)
	updateHotkey(bu)
	--macro name
	na:SetFont(unpack(DB.Font))
	na:ClearAllPoints()
	na:SetPoint("BOTTOMLEFT", bu, -3, 2)
	na:SetPoint("BOTTOMRIGHT", bu, -3, 2)
