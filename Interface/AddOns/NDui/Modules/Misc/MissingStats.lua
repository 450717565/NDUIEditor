	...
	PAPERDOLL_STATCATEGORIES = {
		[1] = {
			...
			stats = {
				...
				[7] = { stat = "ATTACK_DAMAGE", hideAt = 0 },
				[8] = { stat = "ATTACK_AP", hideAt = 0, primary = LE_UNIT_STAT_STRENGTH },
				[9] = { stat = "ATTACK_ATTACKSPEED", hideAt = 0, primary = LE_UNIT_STAT_STRENGTH },
				[10] = { stat = "ATTACK_AP", hideAt = 0, primary = LE_UNIT_STAT_AGILITY },
				[11] = { stat = "ATTACK_ATTACKSPEED", hideAt = 0, primary = LE_UNIT_STAT_AGILITY },
