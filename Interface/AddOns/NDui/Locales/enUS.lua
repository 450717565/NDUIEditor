...
L["ItemDeleteMode"] = "|nYou can destroy container item by holding CTRL+ALT. The item can be heirlooms or its quality lower then rare (blue). "
L["Trait"] = "Trait"
...
L["FavouriteMode"] = "|nYou can now star items.|nIf |'Bags ItemFilter|' enabled, the item you starred will add to Preferences filter slots.|nThis is not available to trash."
