...
L["PlayerPlate Bar Width"] = "資源條寬度"
L["PlayerPlate Bar Height"] = "資源條高度"
...
L["RareAlertInWild"] = "只在野外生效（提示音/聊天窗口）"
