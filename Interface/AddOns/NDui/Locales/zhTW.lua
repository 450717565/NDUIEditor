...
L["PartyFrame Show Yourself"] = "小隊框架中顯示自己"
L["Player Aura"] = "玩家光環"
L["Player Special Aura"] = "玩家重要光環"
L["PlayerPlate CP Height"] = "職業資源條高度"
...
L["Skin Texture"] = "全局紋路背景"
L["Flat Style"] = "扁平風格"
L["Gradient Style"] = "漸變風格"
L["ClassColor Style"] = "職業色風格"
L["Skin Style"] = "前景美化風格"
L["Flat Color"] = "扁平風格顏色"
L["Gradient Color 1"] = "漸變風格顏色 1"
L["Gradient Color 2"] = "漸變風格顏色 2"
L["Backdrop Color"] = "背景美化顏色"
L["Texture Style"] = "材質風格選擇"
L["Instance Difficulty"] = "當前副本難度：%s"
...
L["Buffs Ready"] = "NDui食物精煉檢查：已齊全。"
L["DeadlyBossMods Required"] = "你尚未使用DeadlyBossMods或者BigWigs。"
...
L["Tutorial Page4"] = "|cffff0000注意：本頁的設置為賬號共享。|r|n|n最後，我們將導入Skada、DeadlyBossMods、BigWigs的默認設置（不會鎖定），以使其更符合NDui的整體風格。|n|n你也可以在|cffffcc00控制面板-介面美化|r裏取消它們的皮膚，一切都取決於自己。"
...
L["DeadlyBossMods Skin"] = "啟用DeadlyBossMods皮膚"
L["Micromenu"] = "啟用微型菜單"
L["Menubar"] = "微型菜單欄"
...
L["TellMeWhen Skin"] = "啟用TellMeWhen皮膚"
...
L["Skin Shadow"] = "全局陰影邊框"
L["Backdrop Alpha"] = "背景淡化透明度"
L["Font Outline"] = "全局字體描邊"
