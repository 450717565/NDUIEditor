...
L["GuildWelcome"] = "公會新人歡迎"
L["GuildWelcomeMessage"] = "歡迎 %s 加入公會！"
L["Hours"] = "時"
L["iLvlTools"] = "裝等統計助手"
L["In Raid"] = "妳正在處於團隊中，\n\n大部分非團隊任務將無法完成！"
L["InputDamage"] = "承受傷害"
...
L["LootMonitorBonusRewards"] = "拾取監視過濾掉額外獎勵"
L["LootMonitorInfo"] = "左鍵：貼出 右鍵：密語"
L["LootMonitorInGroup"] = "在隊伍中才顯示拾取監視助手"
L["LootMonitorMessage"] = "妳好！請問%s有需求嗎？沒有的話能讓給我嗎？謝謝！"
L["Minutes"] = "分"
L["Move Talking"] = "移動NPC情景對話窗口"
L["MythicLootItemLevel:"] = "秘境箱子等級："
L["Need Trait"] = "下壹級需要"
L["Need XP"] = "下壹級需要"
L["NoWeeklyItem"] = "沒有低保！"
L["OneNake"] = "單脫"
L["OutputDamage"] = "輸出傷害"
L["OutputHealing"] = "輸出治療"
L["PartyUF"] = "小隊頭像"
L["Red"] = "紅色"
L["Refrsh Mail"] = "刷新郵件"
L["Requires (.+) %- .+"] = "需要 (.+) %- .+"
...
L["Say / Yell"] = "說 / 喊"
L["Seconds"] = "秒"
L["ShowCharacterItemSheet"] = "顯示玩家自己裝備列表"
L["ShowOwnFrameWhenInspecting"] = "觀察同時顯示自己裝備列表"
L["Slot Info"] = "顯示背包裝備物品部位"
L["StarCursor"] = "鼠標閃光助手"
L["To browse item tooltips."] = "搜索增強：對物品詳細提示信息也進行搜索。"
L["TrainAll"] = "訓練全部"
L["TrainAllNeed:"] = "學習全部技能需要："
L["UFs PartyFrame"] = "啟用小隊框體"
L["WeeklyLootItemLevel:"] = "低保箱子等級："
