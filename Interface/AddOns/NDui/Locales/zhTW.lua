...
L["Bags FavouriteButton"] = "背包添加偏好模式按鈕"
L["Bags ItemSlot"] = "顯示背包裝備部位信息"
L["Chat Emote"] = "聊天表情"
L["Custom CD"] = "自定義監控"
L["Cyan"] = "青色"
L["Days"] = "天"
...
L["GW Message 1"] = "歡迎 %s 加入公會！"
L["GW Message 2"] = "喲！有萌新 %s 加入公會了！"
L["GW Message 3"] = "HYHY %s"
L["GW Message 4"] = "歡迎大佬 %s ！"
L["Hours"] = "時"
L["HP Bar Color"] = "血量條顏色"
L["HP Val Mode"] = "血量值顯示方式"
L["iLvlTools"] = "裝等統計助手"
L["In Raid"] = "你正在處於團隊中，|n|n大部分非團隊任務將無法完成！"
L["LM Message 1"] = "你好！請問%s有需求嗎？沒有的話能讓給我嗎？謝謝！"
L["LM Message 2"] = "老哥！求個%s！畢業的！謝謝！"
L["LM Message 3"] = "你好！能讓壹下%s嗎？謝謝！"
...
L["LootMonitor Quality"] = "監控最低品質"
L["LootMonitor Title"] = "拾取監控助手"
L["Minutes"] = "分"
L["Ms: %s"] = "延遲：%s"
L["Mythic Loot Item Level"] = "秘境箱子等級：%s+"
L["Next Need"] = "下壹級需要："
L["Num and Per"] = "數值 + 百分比"
L["One Nake"] = "單脫"
L["Only Number"] = "僅顯示數值"
L["Only Percent"] = "僅顯示百分比"
L["PartyFrame Show Yourself"] = "小隊框体中顯示自己"
L["Player Aura"] = "玩家光環"
L["Player Special Aura"] = "玩家重要光環"
L["PlayerPlate CP Height"] = "職業能量條高度"
L["PlayerPlate HP Height"] = "個人資源條高度"
L["Raid Buff"] = "團隊增益"
L["Raid Debuff"] = "團隊減益"
L["Red"] = "紅色"
L["Refrsh Mail"] = "刷新郵件"
...
L["Skin Alpha"] = "介面線條透明度"
L["Skin Color"] = "介面線條顏色"
L["Spell CD"] = "技能冷卻"
L["TalkingHeadFrame"] = "NPC情景對話框"
L["Target Aura"] = "目標光環"
...
L["Tutorial Page1"] = "下面將指導一些日常功能。|n|n此處將加載一些諸如|cffffcc00動作條、技能監控、團隊框体、名條|r等系統設置來改善插件的易用性。|n|n|cffff0000為防止出現各種異常，強烈建議|r你應用本頁的設置。"
...
L["FocusUF"] = "焦點框体"
L["FoTUF"] = "焦點目標框体"
L["BossFrame"] = "首領/競技場框体"
L["UFs RaidFrame"] = "啟用團隊框体"
L["RaidFrame"] = "團隊框体"
L["Num Groups"] = "顯示隊伍數量"
L["UFs AutoRes"] = "滑鼠中鍵點擊戰複/復活"
L["RaidFrame TeamIndex"] = "顯示隊伍編號"
L["Simple RaidFrame"] = "簡易模式框体"
...
L["RaidFrame Width"] = "團隊框体寬度"
L["RaidFrame Height"] = "團隊框体高度"
L["SimpleMode Scale"] = "簡易模式框体縮放"
...
L["Mover Console"] = "NDui框体移動"
L["Grids"] = "網格"
L["Reset Mover Confirm"] = "你確定重置所有框体的位置嗎？"
...
L["Placed Item Alert"] = "通報隊伍中技能或物品的放置"
...
L["RareAlertInWild"] = "只在野外生效（聲音/聊天窗口）"
...
L["PartyFrame Width"] = "小隊框体寬度"
L["PartyFrame Height"] = "小隊框体高度"
L["Account Keystones"] = "賬號角色鑰石信息"
L["AutoBubbles"] = "副本外關閉聊天氣泡"
L["Default Dark"] = "默認黑色"
L["ClassColorHP"] = "職業顔色"
L["GradientHP"] = "以百分比漸變"
L["Uunat Alert"] = "風暴熔爐烏納特踩圈通報"
L["UunatAlertString"] = "%s踩圈了，纍計%d次。"
L["Bags DeleteButton"] = "背包添加摧毀模式按鈕"
L["ItemDeleteMode"] = "|n你可以按住CTRL+ALT鍵，直接點擊摧毀背包中的傳家寶或者低於藍色精良品質的物品。"
L["Trait"] = "特質"
...
L["UIWidgetFrame"] = "小地圖下方特殊框体|n|n如PVP占點/艾薩拉結界"
...
L["Chatbar"] = "聊天頻道按鈕"
L["UnitFrame Size"] = "頭像各框体尺寸調整"
L["Health Width"] = "框体寬度"
L["Health Height"] = "框体高度"
L["Power Height"] = "能量條高度"
L["Player&Target"] = "玩家和目標框体"
L["Pet&*Target"] = "寵物和副目標框体"
L["Boss&Arena"] = "首領和競技場框体"
L["LockChatWidth"] = "鎖定的寬度"
L["LockChatHeight"] = "鎖定的高度"
L["FavouriteMode"] = "|n你現在可以點擊標記物品。|n若啟用了物品分類存放，還可以將其添加到偏好選擇分類中。|n此操作對垃圾物品無效。"
...
L["PartyPetFrame"] = "小隊寵物框体"
L["UFs PartyPetFrame"] = "啓用小隊寵物框体"
