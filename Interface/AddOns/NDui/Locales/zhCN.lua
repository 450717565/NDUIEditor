...
L["Tutorial Page4"] = "|cffff0000注意：本页的设置为账号共享。|r|n|n最后一步，将导入Skada、DeadlyBossMods、BigWigs的默认位置等设定（不会锁定），以使其更符合NDui的整体风格。|n|n你也可以在|cffffcc00控制面板-界面美化|r里取消它们的皮肤，一切取决于自己。"
...
L["PlayerPlate Bar Width"] = "资源条宽度"
L["PlayerPlate Bar Height"] = "资源条高度"
L["PlayerPlate CP Height"] = "职业资源条高度"
...
L["PartyFrame"] = "小队框体"
L["UFs PartyWatcher"] = "启用小队技能冷却监控"
L["PartyWatcherOnRight"] = "将图标放置在小队另一侧"
