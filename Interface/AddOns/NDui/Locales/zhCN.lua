...
L["Arrow Color"] = "箭头颜色"
L["Ascending"] = "升序"
L["Auto Collapse"] = "首领战斗时自动隐藏任务追踪"
L["Auto Per Row"] = "图标自动换行数量"
L["Bags FavouriteButton"] = "背包添加偏好模式按钮"
L["Bags ItemSlot"] = "显示背包装备部位信息"
L["Chat Emote"] = "聊天表情"
L["InternalCD"] = "自定义监控"
L["Cyan"] = "青色"
L["Days"] = "天"
L["Descending"] = "降序"
L["Double-click"] = "双击"
L["Enchant Aura"] = "玩家特殊光环"
L["Enchant CD"] = "特殊冷却"
L["Extras"] = "增强模块"
L["Favourite"] = "偏好"
L["Focus Special Aura"] = "焦点重要光环"
L["Framerate"] = "帧数"
L["Green"] = "绿色"
L["Guild Welcome"] = "公会新人欢迎"
L["GW Message 1"] = "欢迎 %s 加入公会！"
L["GW Message 2"] = "哟！有萌新 %s 加入公会了！"
L["GW Message 3"] = "HYHY %s"
L["GW Message 4"] = "欢迎大佬 %s ！"
L["Hours"] = "时"
L["HP Bar Color"] = "血量条颜色"
L["HP Val Mode"] = "生命值显示方式"
L["iLvlTools"] = "装等统计助手"
L["In Raid"] = "你正在处于团队中，|n|n大部分非团队任务将无法完成！"
...
L["LootMonitor / StatusReport"] = "拾取 / 通报"
L["LootMonitor Bonus Rewards"] = "拾取监控过滤掉额外奖励"
L["LootMonitor Info"] = "左键：贴出 右键：密语"
L["LootMonitor InGroup"] = "在队伍中才显示拾取监控助手"
L["LootMonitor Quality"] = "监控最低品质"
L["LootMonitor Title"] = "拾取监控助手"
L["Minutes"] = "分"
L["Num and Per"] = "数值 + 百分比"
L["One Nake"] = "单脱"
L["Only Number"] = "仅显示数值"
L["Only Percent"] = "仅显示百分比"
L["PartyFrame Show Yourself"] = "小队框体中显示自己"
L["Player Aura"] = "玩家光环"
L["Player Special Aura"] = "玩家重要光环"
L["Raid Buff"] = "团队增益"
L["Raid Debuff"] = "团队减益"
L["Red"] = "红色"
L["Refrsh Mail"] = "刷新邮件"
...
L["Seconds"] = "秒"
L["Socket"] = "插槽"
L["Show Character Item Sheet"] = "显示玩家自己装备列表"
L["Show Own Frame When Inspecting"] = "观察同时显示自己装备列表"
L["Line Color"] = "自定义颜色"
L["Spell CD"] = "技能冷却"
L["TalkingHeadFrame"] = "NPC情景对话框"
L["Target Aura"] = "目标光环"
L["Target Special Aura"] = "目标重要光环"
L["Train All Need"] = "学习全部 %s 个技能需要：%s"
L["Train All"] = "训练全部"
L["Max Tiers"] = "特质显示层数"
L["Afk Delight"] = "暂离动画"
L["Mythic Level"] = "层数：%s"
...
L["Highlight Color"] = "高亮边框颜色"
L["Selected Color"] = "选中边框颜色"
L["Skin Texture"] = "全局纹路背景"
L["Flat Style"] = "扁平风格"
L["Gradient Style"] = "渐变风格"
L["Skin Style"] = "美化风格"
L["Flat Color"] = "扁平风格颜色"
L["Gradient Color 1"] = "渐变风格颜色1"
L["Gradient Color 2"] = "渐变风格颜色2"
...
L["Assault 3"] = "突袭：无尽虫群"
L["Assault 4"] = "突袭：亚基重现"
L["Assault 5"] = "突袭：阿玛赛特进军"
L["Flat Alpha"] = "扁平风格透明度"
L["Gradient Alpha 1"] = "渐变风格透明度 1"
L["Gradient Alpha 2"] = "渐变风格透明度 2"
L["Gradient Direction"] = "渐变风格方向"
L["Vertical"] = "垂直"
L["Horizontal"] = "水平"
L["Shadow Color"] = "阴影颜色"
L["Free Mount CD"] = "公益免费CD君"
L["ClassColor Shadow"] = "使用职业颜色阴影"
L["Expansion Version"] = "资料片版本"
L["Rare Alert Mode"] = "提示模式增强"
L["Alert Mode 1"] = "添加地图标记"
L["Alert Mode 2"] = "自动追踪地图标记"
L["Crit"] = "爆击"
L["Haste"] = "急速"
L["Mastery"] = "精通"
L["Versa"] = "全能"
L["RaidAurasType"] = "光环显示模式"
L["RaidAurasTypeTip"] = "|n重要增/减益：以大图标显示重要增/减益，仅显示两个图标。|n|n其他选项：均采用暴雪自带逻辑来显示增/减益。|n|n当开启边角指示器时会自动禁用其他选项。"
L["RAT_1"] = "重要增/减益"
L["RAT_2"] = "仅显示增益"
L["RAT_3"] = "仅显示减益"
L["RAT_4"] = "普通增/减益"
...
L["Global Fade Duration"] = "渐变时间"
L["Global Fade Combat"] = "战斗状态"
L["Global Fade Target"] = "目标状态"
L["Global Fade Cast"] = "施法状态"
L["Global Fade Health"] = "血量状态"
L["Global Fade ActionBar"] = "动作条"
L["Global Fade UnitFrame"] = "头像框架"

L["Progression"] = "显示PvE进度"
L["ProgressionTip"] = "添加PvE进度到鼠标提示框。"
L["ShowByShift"] = "按住<Shift>显示PvE进度统计"
...
L["Not Completed"] = "未完成"
L["Special Achievement"] = "特殊成就"
L["KM: Season One"] = "钥石大师：第一赛季"
L["AC: Sire Denathrius"] = "引领潮流：德纳修斯大帝"
L["CE: Sire Denathrius"] = "千钧一发：德纳修斯大帝"
...
L["Pull Required"] = "你尚未使用DeadlyBossMods或者BigWigs。"
L["Rare Found"] = "发现稀有！"
...
L["Tutorial Page2"] = "|cffff0000注意：本页的设置为账号共享。|r|n|n此处将导入Skada、DeadlyBossMods、BigWigs的默认位置等设置（不会锁定），以使其更符合NDui的整体风格。|n|n你也可以在|cffffcc00控制面板-界面美化|r里取消它们的皮肤。"
...
L["RaidFrame"] = "团队框体"
L["Num Groups"] = "显示队伍数量"
L["UFs AutoResurrect"] = "鼠标中键点击战复/复活"
...
L["DeadlyBossMods Skin"] = "启用DeadlyBossMods皮肤"
L["Micro Menu"] = "启用微型菜单"
L["Menubar"] = "微型菜单栏"
...
L["TellMeWhen Skin"] = "启用TellMeWhen皮肤"
...
L["DBM Count"] = "倒数计时秒数"
L["DBM Count Tip"] = "|n为组队工具的倒计时功能设置倒计时时间。|n需要安装DBM或者Bigwigs。"
L["Setup UIScale"] = "调整UI缩放"
L["Hide Tooltip"] = "战斗中隐藏提示框"
L["Follow Cursor"] = "提示框跟随鼠标"
L["Color Border"] = "提示框边框染色"
L["Hide Rank"] = "隐藏公会会阶"
L["Hide Title"] = "隐藏头衔"
...
L["WheelDown"] = "滚轮下"
L["Wheel"] = "滚轮"
L["Explosives Scale"] = "易爆周智能缩放姓名板"
L["Explosives Scale Tip"] = "|n启用后，对于史诗钥石地下城中的爆炸物，放大其姓名板至1.5倍。"
L["DPS Revert Threat"] = "非坦克时反转染色逻辑"
L["Revert Threat Tip"] = "|n启用坦克模式染色后，对于非坦克职业，交换仇恨稳固和仇恨丢失的颜色。"
L["Secure Color"] = "仇恨稳固"
L["Trans Color"] = "仇恨不稳"
...
L["Cast Alert Info"] = "%s 放置了 %s"
L["Cast Alert"] = "通报队伍中施放的特定技能或物品"
L["ExRT Potioncheck"] = "ExRT药水使用报告"
L["Prio Editbox"] = "|n优先级仅限1-6。|n|n输入完毕后，按Enter键生效。"
L["Player Count"] = "%s名玩家"
L["BfA Invasion"] = "阵营突袭"
L["UFs RuneTimer"] = "显示DK符文条的计时"
L["RaidAuraIndicator"] = "启用边角指示器"
L["RaidAuraIndicatorTip"] = "|n在团队框体的边缘添加自己想要的法术监控，可同时监控增益和减益。"
L["AuraIndicatorType"] = "边角指示器模式"
L["AuraIndicatorScale"] = "边角指示器缩放"
L["RAI_Blocks"] = "色块模式"
L["RAI_Icons"] = "图标模式"
L["RAI_Numbers"] = "数字模式"
L["TOPLEFT"] = "左上"
...
L["AuraIndicator"] = "边角光环设置"
L["Rare Alert InWild"] = "只在野外生效"
...
L["Show ChatItemLevel"] = "聊天窗口的装备显示等级"
...
L["Lock ChatWidth"] = "锁定的宽度"
L["Lock ChatHeight"] = "锁定的高度"
...
L["Allow FriendsSpam"] = "允许来自好友的广告"
L["AllowFriendsSpamTip"] = "|n勾选后，将允许来自队友、好友以及公会成员发布的广告。"
L["Timestamp Format"] = "聊天时间戳格式"
L["Font Scale"] = "字体缩放"
...
L["CustomBar Tip"] = "|n启用一条可供自定义的附加动作条。"
L["CustomBar Fader"] = "附加动作条渐隐"
L["CustomBar ButtonSize"] = "动作条尺寸"
L["CustomBar NumButtons"] = "最大显示数量"
L["CustomBar NumPerRow"] = "每行显示数量"
L["HideBossEmote"] = "隐藏Boss表情框体"
L["Chat BGType"] = "聊天窗口背景样式"
L["ShowSolo"] = "单人时显示"
...
L["Enable Map"] = "启用世界地图增强"
L["EnableMapTip"] = "|n关闭后，世界地图的坐标、缩放、移动，以及去除迷雾功能，都将一同被禁用。|n启用Mapster或LeatrixMaps时，将自动关闭地图增强。"
...
L["Send ActionCD"] = "发送动作条冷却状态"
L["Send Action CD Tip"] = "|n启用后，当你指向任意动作条时，可以滚动鼠标滚轮发送其冷却状态。|n|n只对NDui的动作条生效。"
L["Contact"] = "联系方式"
L["UnlockUI"] = "界面移动"
L["Donation"] = "来自%s的打赏"
...
L["PlateCastGlow"] = "重要施法条高亮"
L["PlateCastGlowTip"] = "|n当目标施放你觉得重要的法术时，高亮其法术图标。|n点击齿轮可以自定义这个列表。"
