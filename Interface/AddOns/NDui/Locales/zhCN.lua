...
L["GuildWelcome"] = "公会新人欢迎"
L["GuildWelcomeMessage"] = "欢迎 %s 加入公会！"
L["Hours"] = "时"
L["iLvlTools"] = "装等统计助手"
L["In Raid"] = "你正在处于团队中，\n\n大部分非团队任务将无法完成！"
L["InputDamage"] = "承受伤害"
...
L["LootMonitorBonusRewards"] = "拾取监视过滤掉额外奖励"
L["LootMonitorInfo"] = "左键：贴出 右键：密语"
L["LootMonitorInGroup"] = "在队伍中才显示拾取监视助手"
L["LootMonitorMessage"] = "你好！请问%s有需求吗？没有的话能让给我吗？谢谢！"
L["Minutes"] = "分"
L["Move Talking"] = "移动NPC情景对话窗口"
L["MythicLootItemLevel:"] = "秘境箱子等级："
L["Need Trait"] = "下一级需要"
L["Need XP"] = "下一级需要"
L["NoWeeklyItem"] = "没有低保！"
L["OneNake"] = "单脱"
L["OutputDamage"] = "输出伤害"
L["OutputHealing"] = "输出治疗"
L["PartyUF"] = "小队头像"
L["Red"] = "红色"
L["Refrsh Mail"] = "刷新邮件"
L["Requires (.+) %- .+"] = "需要 (.+) %- .+"
...
L["TrainAll"] = "训练全部"
L["TrainAllNeed:"] = "学习全部技能需要："
L["UFs PartyFrame"] = "启用小队框体"
L["WeeklyLootItemLevel:"] = "低保箱子等级："
