...
L["Chat Emote"] = "聊天表情"
L["Combat Alert"] = "进入/脱离战斗提示"
L["Cyan"] = "青色"
L["Days"] = "天"
L["Difficult"] = "难度："
L["Double-click"] = "双击"
L["Emotion / Roll"] = "表情 / 掷股"
L["Extras"] = "增强模块"
L["Fps: %s"] = "帧数：%s"
L["Green"] = "绿色"
L["Guild / Officer"] = "公会 / 官员"
L["Guild Welcome"] = "公会新人欢迎"
L["Guild Welcome Message"] = "欢迎 %s 加入公会！"
L["Hours"] = "时"
L["iLvlTools"] = "装等统计助手"
L["In Raid"] = "你正在处于团队中，\n\n大部分非团队任务将无法完成！"
L["Input Damage"] = "承受伤害"
L["Input Healing"] = "承受治疗"
L["Instance / Party"] = "副本 / 小队"
L["Instance / Raid"] = "副本 / 团队"
L["Level %d"] = "等级 %d"
L["LootMonitor / StatusReport"] = "拾取 / 通报"
L["LootMonitor"] = "拾取监视助手"
L["LootMonitor Bonus Rewards"] = "拾取监视过滤掉额外奖励"
L["LootMonitor Info"] = "左键：贴出 右键：密语"
L["LootMonitor InGroup"] = "在队伍中才显示拾取监视助手"
L["LootMonitor Message"] = "你好！请问%s有需求吗？没有的话能让给我吗？谢谢！"
L["Minutes"] = "分"
L["Move Talking"] = "移动NPC情景对话窗口"
L["Ms: %s"] = "延迟：%s"
L["Mythic Loot Item Level"] = "秘境箱子等级："
L["Need Trait"] = "下一级需要"
L["Need XP"] = "下一级需要"
L["No Weekly Item"] = "没有低保！"
L["One Nake"] = "单脱"
L["Output Damage"] = "输出伤害"
L["Output Healing"] = "输出治疗"
L["Party UF"] = "小队头像"
L["Red"] = "红色"
L["Refrsh Mail"] = "刷新邮件"
L["Requires (.+) %- .+"] = "需要 (.+) %- .+"
...
L["Star Cursor"] = "鼠标闪光助手"
L["To browse item tooltips"] = "搜索增强：对物品详细提示信息也进行搜索。"
L["Train All"] = "训练全部"
L["Train All Need"] = "学习全部技能需要："
L["UFs PartyFrame"] = "启用小队框体"
L["Weekly Loot Item Level"] = "低保箱子等级："
