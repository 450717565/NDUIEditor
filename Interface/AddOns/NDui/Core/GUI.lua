...
GUI.OptionList = { -- type, key, value, name, horizon, doubleline
	...
	[3] = {
		...
		{3, "UFs", "UFTextScale", L["UFTextScale"].."*", nil, {.8, 1.5, .01}, updateUFTextScale},
		{3, "UFs", "SmoothAmount", DB.MyColor..L["SmoothAmount"].."*", true, {.15, .6, .01}, updateSmoothingAmount, L["SmoothAmountTip"]},
		{},--blank
	...
	[4] = {
		...
		{3, "UFs", "RaidTextScale", L["UFTextScale"].."*", true, {.8, 1.5, .01}, updateRaidTextScale},
	...
	[5] = {
		...
		{1, "Nameplate", "CastbarGlow", L["PlateCastbarGlow"].."*", true, setupPlateCastbarGlow, nil, L["PlateCastbarGlowTip"]},
		{},--blank
	...
	[12] = {
		...
		{3, "Tooltip", "TTScale", L["Tooltip Scale"].."*", true, {.5, 1.5, .1}},
		{},--blank
