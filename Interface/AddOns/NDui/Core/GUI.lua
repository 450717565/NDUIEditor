...
local optionList = {		-- type, key, value, name, horizon, doubleline
	...
	[4] = {
		...
		{1, "UFs", "InstanceAuras", DB.MyColor..L["Instance Auras"], nil, function() setupRaidDebuffs() end},
		{1, "UFs", "RaidClickSets", DB.MyColor..L["Enable ClickSets"], true, function() setupClickCast() end},
