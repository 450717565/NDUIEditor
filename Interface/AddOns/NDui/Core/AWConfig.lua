...
local function CreatePanel()
	...
	local function SortBars(index)
		...
		for k in pairs(barTable[index]) do
			if (index < 11 and NDuiDB["AuraWatchList"][index][k] ~= nil) or (index == 11 and NDuiDB["InternalCD"][k] ~= nil) or (index == 12 and NDuiADB["RaidDebuffs"][k] ~= nil) then
