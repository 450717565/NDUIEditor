...
function Extras:DressUp()
	...
	DOneNake:SetScript("OnClick", function()
		DressUpFrame.ModelScene:UndressSlot(4)
		for i = 16, 19 do
			DressUpFrame.ModelScene:UndressSlot(i)
		end
	end)
	...
	SOneNake:SetScript("OnClick", function()
		SideDressUpFrame.ModelScene:UndressSlot(4)
		for i = 16, 19 do
			SideDressUpFrame.ModelScene:UndressSlot(i)
		end
	end)
