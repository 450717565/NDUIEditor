...
local list = {
	...
	["Player Special Aura"] = { -- 玩家重要光环组
		...
		{AuraID = 118522, UnitID = "player", Text = RAID_BUFF_6},--元素冲击 爆击
		{AuraID = 173183, UnitID = "player", Text = RAID_BUFF_4},--元素冲击 急速
		{AuraID = 173184, UnitID = "player", Text = RAID_BUFF_7},--元素冲击 精通
