...
C.AuraWatchList = {
	...
	["ALL"] = {
		{	Name = "Enchant Aura",
			...
			Mode = "ICON",
			IconSize = 42,
			Pos = EnchantAuraPoint,
			List = {
			-->种族技能
				--石像形态
				{AuraID =  20594, UnitID = "player"},
				--影遁
				{AuraID =  58984, UnitID = "player"},
				--纳鲁的赐福
		...
		-->职业增益
			...
			--战士
				...
				--援护
				{AuraID = 147833, UnitID = "player"},
				--捍卫
				{AuraID = 223658, UnitID = "player"},
		-->杂项
				--狼人狂乱（卡拉赞）
				{AuraID = 228850, UnitID = "player"},
			},
		},
		{	Name = "Raid Debuff",
			Direction = "RIGHT",
		...
		-->燃烧王座
			...
			--传送门守护者哈萨贝尔
				--饱足幽影
				{AuraID = 245118, UnitID = "player", Text = "驱散"},
				--烈焰引爆
				{AuraID = 244709, UnitID = "player", Text = "易伤"},
				--酸性之网
				{AuraID = 246208, UnitID = "player", Text = "被网住"},
				--意识迷雾
				{AuraID = 245099, UnitID = "player", Text = "去脚下"},
			--生命的缚誓者艾欧娜尔
				--邪能之雨
				{AuraID = 248332, UnitID = "player"},
				--反馈-奥术奇点
				{AuraID = 249017, UnitID = "player", Text = L["Get Out"]},
				--反馈-邪污足迹
				{AuraID = 249014, UnitID = "player", Text = "不要移动"},
				--反馈-燃烧的余烬
				{AuraID = 249015, UnitID = "player", Text = L["Get Out"]},
				--反馈-目标锁定
			...
			--瓦里玛萨斯
				--被标记的猎物
				{AuraID = 244042, UnitID = "player", Text = "到近战位"},
				--毁灭回响
			...
			--破坏魔女巫会
				...
				--爆裂脉冲
				{AuraID = 253520, UnitID = "player", Text = L["Get Out"]},
			--阿格拉玛
				--泰沙拉克之触
				...
				--灼热之焰
				{AuraID = 245994, UnitID = "player", Text = L["Get Out"]},
				--强化烈焰撕裂
		...
		{	Name = "Target Special Aura",
			...
			-->职业长控
				...
				--群体缠绕
				{AuraID = 102359, UnitID = "target"},
				--禁锢
				{AuraID = 217832, UnitID = "target"},
				--悲苦咒符
				{AuraID = 207685, UnitID = "target"},
				--变形术
				...
				--冰冻陷阱
				{AuraID =   3355, UnitID = "target"},
				--翼龙钉刺
				{AuraID =  19386, UnitID = "target"},
				--束缚亡灵
				{AuraID =   9484, UnitID = "target"},
				--闷棍
				{AuraID =   6770, UnitID = "target"},
				--致盲
				...
				--忏悔
				{AuraID =  20066, UnitID = "target"},
				--放逐术
				{AuraID =    710, UnitID = "target"},
				--分筋错骨
				{AuraID = 115078, UnitID = "target"},
			-->饰品特效
				--海洋污染
		...
		{	Name = "Enchant Cooldown",
			...
			IconSize = 18,
			BarWidth = 150,
			Pos = EnchantCooldownPoint,
			List = {
			-->物品
				--腰带/戒指/饰品/披风
				{SlotID  =      6, UnitID = "player"},
				{SlotID  =     11, UnitID = "player"},
				{SlotID  =     12, UnitID = "player"},
				{SlotID  =     13, UnitID = "player"},
				{SlotID  =     14, UnitID = "player"},
				{SlotID  =     15, UnitID = "player"},
			-->种族技能
				--石像形态
				{SpellID =  20594, UnitID = "player"},
				--影遁
				{SpellID =  58984, UnitID = "player"},
				--纳鲁的赐福
				...
				--疾步夜行
				{SpellID =  68992, UnitID = "player"},
				--自利
				{SpellID =  59752, UnitID = "player"},
				--逃命专家
				{SpellID =  20589, UnitID = "player"},
				--火箭弹幕
				{SpellID =  69041, UnitID = "player"},
				--火箭跳
				{SpellID =  69070, UnitID = "player"},
				--狂暴
				{SpellID =  26297, UnitID = "player"},
				--战争践踏
				{SpellID =  20549, UnitID = "player"},
				--血性狂怒
				{SpellID =  20572, UnitID = "player"},
				{SpellID =  33697, UnitID = "player"},
				{SpellID =  33702, UnitID = "player"},
				--被遗忘者的意志
				{SpellID =   7744, UnitID = "player"},
				--食尸
				{SpellID =  20577, UnitID = "player"},
				--奥术洪流
	...
	["WARRIOR"] = {
		...
		{	Name = "Target Aura",
			...
			List = {
				...
				--奥丁之怒
				{AuraID = 205546, UnitID = "target", Caster = "player"},
				--创伤
				{AuraID = 215537, UnitID = "target", Caster = "player"},
			},
		},
		{	Name = "Player Special Aura",
			Direction = "LEFT",
			...
			-->狂怒
				...
				--战争机器
				{AuraID = 215562, UnitID = "player"},
				--屠杀
				{AuraID = 206316, UnitID = "player"},
				--感受死亡
				{AuraID = 200979, UnitID = "player"},
				--狂暴
		...
		{	Name = "Spell Cooldown",
			...
			-->天赋
				--震荡波
				{SpellID =  46968, UnitID = "player"},
				--风暴之锤
				{SpellID = 107570, UnitID = "player"},
				--天神下凡
				{SpellID = 107574, UnitID = "player"},
				--浴血奋战
				{SpellID =  12292, UnitID = "player"},
				--剑刃风暴
				{SpellID =  46924, UnitID = "player"},
				{SpellID = 227847, UnitID = "player"},
				--巨龙咆哮
				{SpellID = 118000, UnitID = "player"},
				--防御姿态
				{SpellID = 197690, UnitID = "player"},
				--破坏者
			...
			-->神器
				...
				--奈萨里奥之怒
				{SpellID = 203524, UnitID = "player"},
			-->技能
				--冲锋
				{SpellID =    100, UnitID = "player"},
				--命令怒吼
				{SpellID =  97462, UnitID = "player"},
				--嘲讽
				{SpellID =    355, UnitID = "player"},
				--战吼
				{SpellID =   1719, UnitID = "player"},
				--拳击
				{SpellID =   6552, UnitID = "player"},
				--狂怒回复
				{SpellID = 184364, UnitID = "player"},
				--狂暴之怒
				{SpellID =  18499, UnitID = "player"},
				--破胆怒吼
				{SpellID =   5246, UnitID = "player"},
				--英勇投掷
				{SpellID =  57755, UnitID = "player"},
				--英勇飞跃
				{SpellID =   6544, UnitID = "player"},
				--剑在人在
				{SpellID = 118038, UnitID = "player"},
				--巨人打击
				{SpellID = 167105, UnitID = "player"},
				--援护
				{SpellID = 198304, UnitID = "player"},
				--挫志怒吼
				{SpellID =   1160, UnitID = "player"},
				--法术反射
				{SpellID =  23920, UnitID = "player"},
				--盾墙
				{SpellID =    871, UnitID = "player"},
				--盾牌格挡
				{SpellID =   2565, UnitID = "player"},
				--破釜沉舟
				{SpellID =  12975, UnitID = "player"},
			},
		},
	},
	...
	["DEATHKNIGHT"] = {
		...
		{	Name = "Target Aura",
			...
			-->鲜血
				--饮血者
				{AuraID = 206931, UnitID = "target", Caster = "player"},
				--血之疫病
				...
				--死亡之握
				{AuraID =  51399, UnitID = "target", Caster = "player"},
				--枯萎之握
			...
			-->邪恶
				...
				--衰弱感染
				{AuraID = 208278, UnitID = "target", Caster = "player"},
				--爆发
				{AuraID = 196782, UnitID = "target", Caster = "player"},
				--溃烂之伤
		...
		{	Name = "Spell Cooldown",
			...
			-->神器
				--吞噬
				{SpellID = 205223, UnitID = "player"},
				--辛达苟萨之怒
				{SpellID = 190778, UnitID = "player"},
				--天启
				{SpellID = 220143, UnitID = "player"},
			-->天赋
				--墓石
				{SpellID = 219809, UnitID = "player"},
				--白骨风暴
				{SpellID = 194844, UnitID = "player"},
				--血魔之握
				{SpellID = 108199, UnitID = "player"},
				--窒息
				{SpellID = 221562, UnitID = "player"},
				--符文刃舞
				{SpellID =  49028, UnitID = "player"},
				--吸血鬼之血
				{SpellID =  55233, UnitID = "player"},
				--血之镜像
				{SpellID = 206977, UnitID = "player"},
				--活力分流
				{SpellID = 221699, UnitID = "player"},
			-->技能
				--寒冬号角
				{SpellID =  57330, UnitID = "player"},
				--致盲冰雨
				{SpellID = 207167, UnitID = "player"},
				--饥饿符文武器
				{SpellID = 207127, UnitID = "player"},
				--符文武器增效
				{SpellID =  47568, UnitID = "player"},
				--湮灭
				{SpellID = 207256, UnitID = "player"},
				--冰龙吐息
				{SpellID = 152279, UnitID = "player"},
				--冰霜之柱
				{SpellID =  51271, UnitID = "player"},
				--召唤石鬼像
				{SpellID =  49206, UnitID = "player"},
				--黑暗仲裁者
				{SpellID = 207349, UnitID = "player"},
				--亡者复生
				{SpellID =  46584, UnitID = "player"},
				--黑暗突变
				{SpellID =  63560, UnitID = "player"},
				--凋零符文武器
				{SpellID = 194918, UnitID = "player"},
				--窒息
				{SpellID = 108194, UnitID = "player"},
				--血肉之盾
				{SpellID = 108194, UnitID = "player"},
				--幽魂步
				{SpellID = 212552, UnitID = "player"},
				--黑暗命令
				{SpellID =  56222, UnitID = "player"},
				--死亡之握
				{SpellID =  49576, UnitID = "player"},
				--心灵冰冻
				{SpellID =  47528, UnitID = "player"},
				--反魔法护罩
				{SpellID =  48707, UnitID = "player"},
				--冰封之韧
				{SpellID =  48792, UnitID = "player"},
				--复活盟友
				{SpellID =  61999, UnitID = "player"},
				--邪爆
				{SpellID = 127344, UnitID = "player"},
			},
		},
	},
	...
	["MONK"] = {
		...
		{	Name = "Target Aura",
			...
			List = {
				--猛虎之眼
				{AuraID = 196608, UnitID = "target", Caster = "player"},
				--月之暗面
				{AuraID = 213063, UnitID = "target", Caster = "player"},
				--神鹤印记
				{AuraID = 228287, UnitID = "target", Caster = "player"},
				--碎玉闪电
				{AuraID = 117952, UnitID = "target", Caster = "player"},
				--业报之触
				...
				{AuraID = 115804, UnitID = "target", Caster = "player"},
				--轮回之触
				{AuraID = 115080, UnitID = "target", Caster = "player", Value = true},
				--翔龙在天
		...
		{	Name = "Player Special Aura",
			...
			List = {
				...
				--雷拳之怒
				{AuraID = 242387, UnitID = "player"},
				--禅悟冥想
				{AuraID = 115176, UnitID = "player"},
				--玉珑的祝福
				{AuraID = 199668, UnitID = "player"},
				--利涉大川
				{AuraID = 213177, UnitID = "player"},
				--胆略
				{AuraID = 213341, UnitID = "player"},
				--天才学徒
				{AuraID = 227678, UnitID = "player"},
				--脚步轻盈
				{AuraID = 199407, UnitID = "player"},
				--隐世大师的禁忌之触
				{AuraID = 213114, UnitID = "player"},
				--转化力量
				{AuraID = 195321, UnitID = "player"},
				--力贯千钧
				{AuraID = 129914, UnitID = "player", Combat = true},
				--幻灭踢
		...
		{	Name = "Spell Cooldown",
			...
			-->天赋
				--真气爆裂
				{SpellID = 123986, UnitID = "player"},
				--真气波
				{SpellID = 115098, UnitID = "player"},
				--真气突
				{SpellID = 115008, UnitID = "player"},
				--迅如猛虎
				{SpellID = 116841, UnitID = "player"},
				--豪能酒
				{SpellID = 115288, UnitID = "player"},
				--平心之环
				{SpellID = 116844, UnitID = "player"},
				--扫堂腿
				{SpellID = 119381, UnitID = "player"},
				--金创药
				{SpellID = 122281, UnitID = "player"},
				--散魔功
				{SpellID = 122783, UnitID = "player"},
				--躯不坏
				{SpellID = 122278, UnitID = "player"},
				--白虎下凡
				{SpellID = 123904, UnitID = "player"},
				--屏气凝神
				{SpellID = 152173, UnitID = "player"},
				--玄牛酒
				{SpellID = 115399, UnitID = "player"},
				--玄牛雕像
				{SpellID = 115315, UnitID = "player"},
				--玄牛砮皂
				{SpellID = 132578, UnitID = "player"},
				--禅意波
				{SpellID = 124081, UnitID = "player"},
				--踏雾而行
				{SpellID = 197945, UnitID = "player"},
				--赤精之歌
				{SpellID = 198898, UnitID = "player"},
				--朱鹤赤精
				{SpellID = 198664, UnitID = "player"},
				--青龙雕像
				{SpellID = 115313, UnitID = "player"},
				--法力茶
				{SpellID = 197908, UnitID = "player"},
			-->技能
				--业报之触
				{SpellID = 122470, UnitID = "player"},
				--分筋错骨
				{SpellID = 115078, UnitID = "player"},
				--切喉手
				{SpellID = 116705, UnitID = "player"},
				--嚎镇八方
				{SpellID = 115546, UnitID = "player"},
				--清创生血
				{SpellID = 218146, UnitID = "player"},
				{SpellID = 115450, UnitID = "player"},
				--滚地翻
				{SpellID = 109132, UnitID = "player"},
				--翔龙在天
				{SpellID = 101545, UnitID = "player"},
				--轮回之触
				{SpellID = 115080, UnitID = "player"},
				--风火雷电
				{SpellID = 137639, UnitID = "player"},
				--魂体双分
				{SpellID = 101643, UnitID = "player"},
				--魂体双分：转移
				{SpellID = 119996, UnitID = "player"},
				--壮胆酒
				{SpellID = 115203, UnitID = "player"},
				--还魂术
				{SpellID = 115310, UnitID = "player"},
				--火焰之息
				{SpellID = 115181, UnitID = "player"},
				--禅悟冥想
				{SpellID = 115176, UnitID = "player"},
				--作茧缚命
				{SpellID = 116849, UnitID = "player"},
				--复苏之雾
				{SpellID = 115151, UnitID = "player"},
				--雷光聚神茶
				{SpellID = 116680, UnitID = "player"},
			-->神器
				--风领主之击
				{SpellID = 205320, UnitID = "player"},
				--爆炸酒桶
				{SpellID = 214326, UnitID = "player"},
			},
		},
	},
	...
	["DEMONHUNTER"] = {
		...
		{	Name = "Target Aura",
			...
			-->复仇
				...
				--猛烈的死亡
				{AuraID = 212818, UnitID = "target", Caster = "player"},
				--幽魂炸弹
		...
		{	Name = "Spell Cooldown",
			...
			-->浩劫
				...
				--复仇回避
				{SpellID = 198793, UnitID = "player"},
				--幻影打击
				{SpellID = 196718, UnitID = "player"},
				--涅墨西斯
				{SpellID = 206491, UnitID = "player"},
				--混乱新星
				{SpellID = 179057, UnitID = "player"},
				--疾影
				{SpellID = 198589, UnitID = "player"},
				--眼棱
				{SpellID = 198013, UnitID = "player"},
				--邪能冲撞
				{SpellID = 195072, UnitID = "player"},
				--虚空行走
				{SpellID = 196555, UnitID = "player"},
				--混乱之刃
			...
			-->复仇
				...
				--强化结界
				{SpellID = 218256, UnitID = "player"},
				--悲苦咒符
				{SpellID = 207684, UnitID = "player"},
				--折磨
				{SpellID = 185245, UnitID = "player"},
				--沉默咒符
				{SpellID = 202137, UnitID = "player"},
				--灵魂切削
				{SpellID = 207407, UnitID = "player"},
				--烈火烙印
				{SpellID = 204021, UnitID = "player"},
				--烈焰咒符
				{SpellID = 204596, UnitID = "player"},
				--锁链咒符
				{SpellID = 202138, UnitID = "player"},
				--邪能毁灭
				{SpellID = 212084, UnitID = "player"},
				--恶魔灌注
			...
			-->通用
				...
				--吞噬魔法
				{SpellID = 183752, UnitID = "player"},
				--禁锢
				{SpellID = 217832, UnitID = "player"},
				--邪能爆发
				{SpellID = 211881, UnitID = "player"},
				--恶魔变形
