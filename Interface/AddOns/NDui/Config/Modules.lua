...
C.Infobar = {
	...
	Friends			= true,													-- 好友信息
	FriendsPos		= {"TOPLEFT", UIParent, "TOPLEFT", 125, -7},			-- 好友信息位置
	Latency			= true,													-- 延迟信息
	LatencyPos		= {"TOPLEFT", UIParent, "TOPLEFT", 230, 7},				-- 延迟信息位置
	System			= true,													-- 帧数信息
	SystemPos		= {"TOPLEFT", UIParent, "TOPLEFT", 335, -7},			-- 帧数信息位置
	MaxAddOns		= 12,													-- 插件信息显示数量
	Location		= true,													-- 区域信息
	LocationPos		= {"TOPLEFT", UIParent, "TOPLEFT", 440, -7},			-- 区域信息位置
