...
BOSS = 2428 -- 饥饿的毁灭者
AT:RegisterDebuff(TIER, INSTANCE, BOSS, 340630) -- 小怪
...
AT:RegisterDebuff(TIER, INSTANCE, BOSS, 325117) -- 心能释放
...
AT:RegisterDebuff(TIER, INSTANCE, BOSS, 329906) -- 屠戮
AT:RegisterDebuff(TIER, INSTANCE, BOSS, 334016, 6) -- 落选者