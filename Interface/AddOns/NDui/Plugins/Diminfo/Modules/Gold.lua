...
if cfg.Gold == true then
	...
	Stat:SetScript("OnEnter", function(self)
		...
		GameTooltip:AddDoubleLine(infoL["Earned"], GetMoneyString(Earned), 1,1,1, 1,1,1)
		GameTooltip:AddDoubleLine(infoL["Spent"], GetMoneyString(Spent), 1,1,1, 1,1,1)
		if Earned < Spent then
			GameTooltip:AddDoubleLine(infoL["Deficit"], GetMoneyString(Spent-Earned), 1,0,0, 1,1,1)
		elseif Earned > Spent then
			GameTooltip:AddDoubleLine(infoL["Profit"], GetMoneyString(Earned-Spent), 0,1,0, 1,1,1)
		end
		GameTooltip:AddLine(" ")
