...
function PGF.Dialog_InfoButton_OnEnter(self, motion)
	...
	GameTooltip:AddLine(" ")
	PGF.GameTooltip_AddDoubleWhite("bod/daz达萨罗 cs/cru风暴熔炉", L["dialog.tooltip.raids"])
	PGF.GameTooltip_AddWhite("ete/tep永恒王宫 nya/ny尼奥罗萨")
	GameTooltip:AddLine(" ")
	PGF.GameTooltip_AddDoubleWhite("ad阿塔 fh自由 kr诸王 sob围攻 sots风暴", L["dialog.tooltip.dungeons"])
	PGF.GameTooltip_AddWhite("td监狱 tml暴富 tosl神庙 tur地渊 wm庄园")
	PGF.GameTooltip_AddWhite("opm麦卡贡 opmj垃圾场 opmw车间")
	GameTooltip:AddLine(" ")
