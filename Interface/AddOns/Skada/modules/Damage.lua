Skada:AddLoadableModule("Damage", nil, function(Skada, L)
	...
	local function dps_tooltip(win, id, label, tooltip)
		...
		if player then
			...
			tooltip:AddDoubleLine(L["Segment time"], totaltime.."秒", 255,255,255,255,255,255)
			tooltip:AddDoubleLine(L["Active time"], activetime.."秒", 255,255,255,255,255,255)
			tooltip:AddDoubleLine(L["Damage done"], Skada:FormatNumber(player.damage), 255,255,255,255,255,255)
			tooltip:AddDoubleLine(Skada:FormatNumber(player.damage) .. " / " .. activetime .. "秒 :", Skada:FormatNumber(player.damage / math.max(1,activetime)), 255,255,255,255,255,255)
