Skada:AddLoadableModule("Damage", nil, function(Skada, L)
	...
	local function dps_tooltip(win, id, label, tooltip)
		...
		if player then
			...
			tooltip:AddDoubleLine(L["Segment time"], totaltime.."̑", 255,255,255,255,255,255)
			tooltip:AddDoubleLine(L["Active time"], activetime.."̑", 255,255,255,255,255,255)
			tooltip:AddDoubleLine(L["Damage done"], Skada:FormatNumber(player.damage), 255,255,255,255,255,255)
			tooltip:AddDoubleLine(Skada:FormatNumber(player.damage) .. " / " .. activetime .. "̑ :", Skada:FormatNumber(player.damage / math.max(1,activetime)), 255,255,255,255,255,255)
