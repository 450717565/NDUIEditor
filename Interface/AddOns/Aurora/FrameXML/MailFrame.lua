...
tinsert(C.themes["Aurora"], function()
	...
	OpenMailCancelButton:SetWidth(80)
	OpenMailDeleteButton:SetWidth(81)
	OpenMailReplyButton:SetWidth(81)
	...
	for i = 1, INBOXITEMS_TO_DISPLAY do
		...
		local ic = _G["MailItem"..i.."ButtonIcon"]
		local bd = _G["MailItem"..i.."ButtonIconBorder"]
