...
function ExtVendor_Setup()
	...
	ExtVendor_CheckSetting("enable_quickvendor", false);
	ExtVendor_CheckSetting("filter_purchased_recipes", false);
	ExtVendor_CheckSetting("high_performance", false);
	ExtVendor_CheckSetting("hide_known_heirlooms", false);
	ExtVendor_CheckSetting("hide_known_toys", false);
	ExtVendor_CheckSetting("hide_known_mounts", false);
