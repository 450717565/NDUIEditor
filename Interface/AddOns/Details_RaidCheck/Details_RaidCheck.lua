...
--> create the plugin object
	...
	local CreatePluginFrames = function()
		...
		report_string1:SetText ("|TInterface\\TUTORIALFRAME\\UI-TUTORIAL-FRAME:12:12:0:1:512:512:8:70:225:307|t 报告没有食物/合剂  |TInterface\\TUTORIALFRAME\\UI-TUTORIAL-FRAME:12:12:0:1:512:512:8:70:328:409|t 报告没有预喝药水  |TInterface\\TUTORIALFRAME\\UI-TUTORIAL-FRAME:12:12:0:1:512:512:8:70:126:204|t 报告没有符文  |  |cFFFFFFFFShift+单击: 设置|r") 
		...
		using_details_string1:SetText ("当玩家改变天赋和装备时，从其他Details收动态更新！")
		...
		local headerTable = {
			...
			{text = "合剂", width = 50},
			{text = "符文", width = 50},
			{text = "上一次尝试预喝药水", width = 100},
			{text = "使用Details!", width = 100},
		}
		local headerOptions = {
			padding = 2,
		}
		...
		DetailsRaidCheck.ToolbarButton:SetScript ("OnClick", function (self, button)
			...
			if (button == "LeftButton") then
				--> link no food/flask
				local s, added = "Details!: 没有食物或者合剂: ", {}
...
local build_options_panel = function()
	...
	local options_frame = DetailsRaidCheck:CreatePluginOptionsFrame ("DetailsRaidCheckOptionsWindow", "Details! 团本检查设置", 1)
	...
	local menu = {
		...
		{type = "label", get = function() return "食物等级追踪:" end, text_template = DF:GetTemplate ("font", "ORANGE_FONT_TEMPLATE")},
		{
			type = "toggle",
