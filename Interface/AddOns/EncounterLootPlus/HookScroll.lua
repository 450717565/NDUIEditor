...
EncounterJournal_LootUpdate_ELP = function()
	if db.range == 0 then
		...
		return ELP.RunHooked("EncounterJournal_LootUpdate")
	end
	if ELP.IsRetrieving() then return end
...
EncounterJournal_SetLootButton_ELP = function(item)
	...
	if db.range == 0 then return ELP.RunHooked("EncounterJournal_SetLootButton", item) end
...
EncounterJournal_Loot_OnClick_ELP = function(self)
	if db.range == 0 then return ELP.RunHooked("EncounterJournal_Loot_OnClick", self) end
...
ELP.initScroll = function()
	ELP.Hook("EncounterJournal_LootUpdate", EncounterJournal_LootUpdate_ELP)
	ELP.Hook("EncounterJournal_SetLootButton", EncounterJournal_SetLootButton_ELP)
	ELP.Hook("EncounterJournal_Loot_OnClick", EncounterJournal_Loot_OnClick_ELP)
	...
	hooksecurefunc("EJ_ResetLootFilter", ELP.UpdateItemList)
	hooksecurefunc(ELP, "UpdateItemList", function() EncounterJournal.encounter.info.lootScroll.scrollBar:SetValue(0) end)
