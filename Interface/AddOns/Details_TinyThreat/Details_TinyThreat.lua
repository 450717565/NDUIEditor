...
ThreatMeter:SetPluginDescription ("用于跟踪团队成员在当前目标仇恨的小工具.")
...
local build_options_panel = function()
	...
	local options_frame = ThreatMeter:CreatePluginOptionsFrame ("ThreatMeterOptionsWindow", "仇恨监控设置", 1)
